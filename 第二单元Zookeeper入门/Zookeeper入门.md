...
![1573785069536](imgs/1573785069536.png)



## 2.2 zookeepr简介

Zookeeper是一个开源的**分布式**的，为分布式应用提供**协调**服务的Apache项目。
...
### zookeeper工作机制
 ...
 ![1569543458068](imgs/1569543458068.png) 

### 2.2.1 特点

![1569543509025](imgs/1569543509025.png)

![1569543530475](imgs/1569543530475.png)

### 2.2.2 **数据结构**

![1569543575407](imgs/1569543575407.png)
...
![1569543649163](imgs/1569543649163.png)

#### 统一配置管理

![1569543724628](imgs/1569543724628.png)

#### 统一集群管理

![1569543790856](imgs/1569543790856.png)

#### 服务器动态上下线

![1569543891934](imgs/1569543891934.png)

#### 负载均衡

![1569543931756](imgs/1569543931756.png)
...
![1568008641563](imgs/1568008641563.png)

第三步：解压缩压缩包 tar  -zxvf  解压到指定目录

![1568011374878](imgs/1568011374878.png)

第四步：进入 zookeeper的安装目录，创建 data 文件夹，用于存储zookeeper的数据

![1568011334369](imgs/1568011334369.png)

第五步：进入conf目录 ，把 zoo_sample.cfg 改名为 zoo.cfg，默认识别zoo.cfg配置文件

![1568011362904](imgs/1568011362904.png)

第六步：打开zoo.cfg ,  修改 data 属性：dataDir=/opt/zookeeper-3.4.10/data,指定数据存储的路径地址

第七步：配置环境遍历  vim /etc/profile

![1568009112192](imgs/1568009112192.png)

生效文件

![1568009137134](imgs/1568009137134.png)

第八步:启动zookeeper

![1568011297592](imgs/1568011297592.png)

第九步:查看状态： zkServer.sh status

![1568009250843](imgs/1568009250843.png)

第十步:关闭zookeeper 输入命令zkServer.sh stop

![1568009325681](imgs/1568009325681.png)

### 2.3.2 配置文件详解

切换到指定的目录

![1573784505925](imgs/1573784505925.png)

查看zoo.cfg配置文件

![1573784431466](imgs/1573784431466.png)
