...
​	![1585784986839](第十三单元 分类管理及规格参数管理.assets/1585784986839.png) 

### 13.1.0  前提条件

 	1. 使用bootstap3  或者 bootstrap4 增加gy字体。
 	2. jquery 
...
​	列表效果
   ...
   ![1585785186249](第十三单元 分类管理及规格参数管理.assets/1585785186249.png) 
...
3. 添加规格
   ...
   ![1585785299695](第十三单元 分类管理及规格参数管理.assets/1585785299695.png) 
